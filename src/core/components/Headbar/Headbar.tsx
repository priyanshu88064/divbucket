...
import { updateRootWidth } from "@core/state/reducers/treeReducer";
...
const Code = () => {
  const tabs = useSelector(
    (state: RootState) => state.treeReducer.nodeChildrenMap[-1],
  );
        ...
        {tabs.map((tab, ind) => (
          <div
            ...
            className={`
              ...
              ${ind === activeCodeIndex ? "bg-gray-600" : ""}
            `}
            onClick={() => setActiveCodeIndex(ind)}
          >
            <FaHome />
            {dataMap[tab].name}
          </div>
      ...
      <div className={styles.codearea}>
        <div
          ...
          onClick={() => {
            ...
            else navigator.clipboard.writeText(code[activeCodeIndex].css);
