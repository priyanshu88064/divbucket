...
const treeSlice = createSlice({
  ...
  initialState: {
    ...
    dataMap: {
      ...
      '59187': {
        ...
        src: '',
        alt: '',
        content: 'Divbucket is currently in the development phase, and I\'m working hard to make it better every day! As this project continue to improve, you can expect new features, enhanced performance, and even more customization options to make website creation easier than ever.',
        unit: true
      },
      '126765': {
        name: 'Block',
      ...
      '208325': {
        ...
        src: '',
        alt: '',
        content: 'Go beyond basic designs and create complex, interactive components effortlessly—without any coding.',
        unit: true
      },
      '227285': {
        name: 'Row',
      ...
      '356969': {
        ...
        src: '',
        alt: '',
        content: 'Drag-and-drop editor makes website building as simple as moving elements on a page.  You can effortlessly add, arrange, and customize text, images, buttons, forms, and more.',
        unit: true
      },
      '359031': {
        name: 'Paragraph',
        ...
        src: '',
        alt: '',
        content: 'Stay tuned for updates, and feel free to share your thoughts.',
        unit: true
      },
      '373040': {
        name: 'Text',
      ...
      '468371': {
        ...
        src: '',
        alt: '',
        content: 'Divbucket is an intuitive no-code website builder that empowers anyone to create professional websites without any technical expertise.',
        unit: true
      },
      '487938': {
        name: 'Text',
      ...
      '579774': {
        ...
        src: '',
        alt: '',
        content: 'Create Stunning Websites Without Writing a Single Line of Code!',
        unit: true
      },
      '607585': {
        name: 'Text',
  ...
  reducers: {
    ...
    cut: (state) => {
      ...
      treeSlice.caseReducers.deleteFromParent(state,{payload:{id:cutNode}})
